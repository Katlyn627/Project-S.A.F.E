...
export const TelemetryView: React.FC = () => {
  ...
  const handleResetAndSeed = async () => {
    ...
    try {
      ...
      setSeedMessage('Loaded UNESCO-aligned dataset: 216 students across 8 schools in Kenya, Uganda, and Tanzania (1,500+ attendance records, 16 casework alerts, 8 multi-lingual voice notes).')
    } catch {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div>
            ...
            <h2 className="text-lg font-bold text-slate-900 mt-1 flex items-center gap-2">
              ...
              Regional Impact Matrix &amp; Donor Economics (East Africa)
            </h2>
            <p className="text-xs text-slate-500 mt-0.5">
              Empirical M&amp;E indicators across Kenya 🇰🇪, Uganda 🇺🇬, and Tanzania 🇹🇿
            </p>
          </div>
          ...
          >
            ...
            Re-Seed 216 Students &amp; Multi-Country Data
          </button>
        </div>
        ...
        <div className="mt-6 rounded-2xl border border-sky-200 bg-sky-50/60 p-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-sky-200/70 pb-3">
            <div className="flex items-center gap-2 font-bold text-sm text-sky-950">
              ...
              UNESCO Global Data &amp; HerAtlas Benchmark Alignment
            </div>
            <a
            ...
            >
              <span>View Official UNESCO Data</span>
          ...
          <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-slate-700">
            <div className="bg-white/80 p-3 rounded-xl border border-sky-100">
              <span className="text-slate-500 font-medium">Global Out-of-School Girls</span>
              <p className="text-lg font-bold text-sky-950 mt-0.5">122+ Million</p>
              <p className="text-[11px] text-slate-500">Highest concentration in Sub-Saharan Africa</p>
            </div>

            <div className="bg-white/80 p-3 rounded-xl border border-sky-100">
              <span className="text-slate-500 font-medium">Rural Lower Secondary Completion</span>
              <p className="text-lg font-bold text-rose-800 mt-0.5">Only 40%</p>
              <p className="text-[11px] text-slate-500">Adolescent female completion in rural Africa</p>
            </div>

            <div className="bg-white/80 p-3 rounded-xl border border-sky-100">
              <span className="text-slate-500 font-medium">Economic Return on Secondary Ed</span>
              <p className="text-lg font-bold text-emerald-800 mt-0.5">+15% to +25%</p>
              <p className="text-[11px] text-slate-500">Future wage increase per additional school year</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm space-y-4">
          <h3 className="text-sm font-bold uppercase tracking-wider text-slate-800 flex items-center gap-2">
            ...
            Adolescent Female Absenteeism Drivers (UNESCO Field Grounded)
          </h3>
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 rounded-xl bg-slate-950 p-4 text-xs text-slate-300 font-mono">
          <div className="flex items-center justify-between text-slate-400 border-b border-slate-800 pb-2 mb-2">
            ...
            <span className="text-emerald-400">UNESCO_HERATLAS_ALIGNED</span>
          </div>
          ...
          <div>Storage Budget: &lt; 410 KB precached asset bundle (Hard limit: 1.8 MB)</div>
        </div>
      </div>
    </div>
  )
